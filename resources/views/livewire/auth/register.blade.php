<div>
    <div class="text-center">
        <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">{{ __('Create an account') }}</h1>
    ...
    <div class="mt-5">
        ...
        <form wire:submit="register">
            <div class="grid gap-y-4">
                <!-- Name Form Group -->
                <div>
                    <label for="name" class="block text-sm mb-2 dark:text-white">{{ __('Name') }}</label>
                    <div class="relative">
                        <input type="text"
                               id="name"
                               wire:model="name"
